...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { content: @lecture.content, course_id: @lecture.course_id, user_id: @lecture.user_id } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { content: @lecture.content, course_id: @lecture.course_id, user_id: @lecture.user_id } }
